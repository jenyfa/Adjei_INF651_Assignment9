...
async function  getComments (postID) {
    ...
    let comments = await fetch ('https://jsonplaceholder.typicode.com/comments' + post.data['id']);
...
async function getUser (userID) {
    results = {}
    let post =  await fetch ('https://jsonplaceholder.typicode.com/posts' + userID)
    let user = await fetch ('https://jsonplaceholder.typicode.com/users' + user.data['id']);
    results ['user'] = user.data;
    return results;
}
...
async function getTodosForUser(userID) {
    ...
    let todos = await fetch ('https://jsonplaceholder.typicode.com/todos' + user.data ['id']);
    results ['todos'] = user.data;
    return results;
}
